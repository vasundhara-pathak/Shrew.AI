...
When the evolution speed is set to 6, it takes the A.I. roughly 50 generations to reach the first checkpoint, 120 generations to reach the second, and so on. Never skipping a checkpoint or dying in the face of attackers, the learning process eventually succeeds. Be patient with Shrew A.I.; it took you nearly 8 million years to evolve.
